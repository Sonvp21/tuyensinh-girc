                            ...
                            <tbody>
                                @foreach ($contacts as $index => $contact)
                                    <tr>
                                        ...
                                        <td class="text-left font-semibold">{{ $contact->name }}</td>
                                        <td>{{ $contact->email }}</td>
                                        <td>{{ $contact->phone }}</td>
                                        <td>{{ $contact->read_at }}</td>
                                        <td>{{ $contact->createdAtVi }}</td>
                                        <td class="!flex" style="justify-content: space-evenly;">
                                            <a href="{{ route('admin.contacts.show', $contact->id) }}" class="mr-2">
                                            ...
                                            <dialog id="confirm-modal-{{ $contact->id }}" class="modal">
                                                ...
                                                <div class="modal-box">
                                                    ...
                                                    <p class="py-4 text-base text-center">Bạn có chắc muốn xoá liên hệ này?</p>
