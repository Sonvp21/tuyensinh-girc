                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">@php
                                        $latestImage = $user->images->first();
                                    @endphp

                                        @if ($latestImage)
                                            <img class="rounded-full" src="{{ Storage::url($latestImage->file_path) }}"
                                                alt="{{ $latestImage->file_name }}" width="50" height="50">
                                        @else
                                            <span>No image</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <span class="text-xs px-3 py-1 rounded-full text-lime-700 font-bold">{!! $user->status_label !!}</span>
                                    </td>
                                    <td class="text-center">
