                        ...
                        <div x-data="{ open: false }">
                            ...
                            <div x-data="{ open: false }">
                                ...
                                <ul x-cloak x-show="open" x-transition
                                    ...
                                    <li>
                                        <div class="flex items-start">
                                            <input id="communes-checkbox" type="checkbox" name="communes"
                                                value="m"
                                                class="h-4 w-4 rounded border-slate-300 bg-slate-200 text-blue-600 focus:ring-2 focus:ring-blue-500"
                                                checked />
                                            <label for="communes-checkbox"
                                                class="ml-2 text-sm font-medium text-slate-900">
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div>
                                            <label class="form-control w-full max-w-xs">
                                                <div class="label">
                                                    <span class="label-text">Chọn Huyện</span>
                                                </div>
                                                <select id="districtSelect" class="select select-bordered select-sm py-0 w-[calc(100%)]">
                                        ...
                                        <div>
                                            <div class="label" id="communeSelectLabel">
                                                <span class="label-text">Chọn xã</span>
                                            </div>
                                            <select id="communeSelect" class="select select-bordered select-sm py-0 w-[calc(100%)]">
