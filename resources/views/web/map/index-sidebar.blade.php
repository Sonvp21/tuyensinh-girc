...
<body class="font-sans antialiased">
            ...
            <ul class="menu block bg-base-200 bg-opacity-80 text-base-content min-h-full">
                <div x-data="{ open: false }">
                    ...
                    <div x-data="{ open: true }">
                        ...
                        <ul x-cloak x-show="open" x-transition class="ml-6 space-y-2 border-l border-slate-300 p-2">
                            <li>
                                <div class="flex items-start">
                                    <input id="vung_trongs-checkbox" type="checkbox" name="vung_trongs" value="vt"
                                        class="h-4 w-4 rounded bg-slate-200 text-blue-600 focus:ring-2 focus:ring-blue-500"
                                        checked />
                                    <label for="vung_trongs-checkbox" class="ml-2 text-sm font-medium text-slate-900">
                                        Vùng trồng
                                    </label>
                                </div>
                            </li>
    ...
    <div class="w-[17.5rem] h-96" id="map">

    </div>
    {{-- <div class="contents justify-between">
        <!-- Drawer -->
        <input id="my-drawer-1" type="checkbox" class="drawer-toggle" />
        <div class="drawer-side block absolute" style="width: -webkit-fill-available; height: -webkit-fill-available;">
            <ul class="menu block bg-base-200 bg-opacity-80 text-base-content min-h-full">
                <div x-data="{ open: false }">
                    <div @click="open =! open" :class="open && 'bg-slate-100 '"
                        class="flex cursor-pointer items-center justify-between px-4 py-2 text-sm font-bold tracking-tight text-slate-700 hover:bg-slate-100">
        ...
        <div class="absolute bottom-0 z-20 col-span-3 flex w-full gap-1 bg-slate-100 bg-opacity-80">
            <!-- Nút icon toggle Drawer -->
            <div id="layer-toggle-1" class="flex h-8 w-1/2 cursor-pointer items-center justify-center text-slate-700"
