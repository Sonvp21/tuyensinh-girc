                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="space-y-4 py-4 text-base leading-6 text-slate-700 sm:text-lg sm:leading-7">
                                <div class="relative hidden">
                                    <input value="admin@gmail.com" autocomplete="on" id="email" name="email" type="text"
                                ...
                                <div class="relative pt-5">
                                    <button type="submit"
                                        class="disabled:opacity-75 inline-flex items-center px-4 py-2 bg-green-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-600 focus:bg-green-600 active:bg-green-900 focus:outline-none focus:ring-2 focus:ring-lime-500 focus:ring-offset-2 transition ease-in-out duration-150 w-full justify-center">
                                        {{-- Đăng nhập --}}
                                        Xác nhận
                                    </button>
                                </div>
