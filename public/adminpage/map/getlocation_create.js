                ...
                img.onload = function() {
                    EXIF.getData(img, function() {
                        ...
                        if (lat && lon && latRef && lonRef) {
                            var latDecimal = convertDMSToDecimal(lat[0], lat[1], lat[2], latRef);
                            var lonDecimal = convertDMSToDecimal(lon[0], lon[1], lon[2], lonRef);
                            ...
                            console.error("Không tìm thấy thông tin vị trí GPS trong hình ảnh.");
                        }
                    });
                };
            };
...
function initMap() {
    map = new google.maps.Map(document.getElementById("map"), {
        ...
        center: {
            lat: 10.243,
            lng: 106.372
        } // Vị trí ban đầu là {10.243, 106.372}
    });
